...
N_EPOCHS = 3       # The number of times to iterate over the training set
...
#Create new network
digitNetwork = NeuralNetwork("testNetworkConv", layers)
...
try:
    ...
    digitNetwork.train(imageData.reshape(-1, 1, 28, 28)[:25*32,:,:,:], labelData, costFunction, BATCH_SIZE, N_EPOCHS, LEARNING_RATE, True, testImages.reshape(-1, 1, 28, 28), testLabels)
